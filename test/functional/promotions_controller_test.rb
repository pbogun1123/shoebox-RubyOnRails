...
class PromotionsControllerTest < ActionController::TestCase
  ...
  test "should update promotion" do
    put :update, id: @promotion, promotion: { description: @promotion.description, enddate: @promotion.enddate, imagepath: @promotion.imagepath, startdate: @promotion.startdate, title: @promotion.title }
    assert_redirected_to promotion_path(assigns(:promotion))
  end
